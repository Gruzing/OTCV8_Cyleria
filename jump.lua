--- zrodlo: https://github.com/felipepips/vBot_1.0f/blob/master/zxVarios/zJump.lua
...
-- Przekonwertujmy `pss` na ciąg znaków, aby dowiedzieć się, które polecenia `pos` zostały już zapisane.
